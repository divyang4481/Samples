...
{
    public class when_using_unit_of_work : Specification
    {
        protected UnitOfWork Target;
        ...
        protected override void Establish_context()
        {
            ...
            Target = Kernel.Get<UnitOfWork>();
        }

        public class and_attempting_to_add_and_commit_changes_and_read_item_type_from_database : when_using_unit_of_work
        {
